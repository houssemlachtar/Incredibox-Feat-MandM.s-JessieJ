...
function popupGate() {
    $boxPopup.$pop.clean(), $("#popup-gate")
        ...
        .appendTo($boxPopup.$pop.$content), $boxPopup.$pop.reflow(), $boxPopup.open({
            ...
            custom: !0,
            locked: !0
        }), $boxPopup.$pop.$icon.unbind(), $boxPopup.$pop.$icon.attr("href", "")
}
...
function popupGateSorry() {
    $boxPopup.$pop.$content.find(".title")
        ...
        .append("<a href='' target='_blank' rel='external' class='big-button' id='bt-understand'>" + STR("bt.understand") + "</a>"), $boxPopup.$pop.$content.find(".cont")
